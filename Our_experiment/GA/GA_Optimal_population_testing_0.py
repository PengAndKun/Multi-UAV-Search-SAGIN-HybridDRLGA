...
from Our_experiment.HCSAC.UAV_VIS_offloading import visualize_trajectory_from_action as vis
...
best_solution, best_fitness, trajectory_actions, offload_actions = pack.load_results("results.pkl")

print(f'best_solution {best_solution} best_fitness {best_fitness} trajectory_actions {len(trajectory_actions)} offload_actions {len(offload_actions)}')
vis(agent, offload_agent, env,best_solution[:env.N],best_solution[env.N:],trajectory_actions,offload_actions,8876)
