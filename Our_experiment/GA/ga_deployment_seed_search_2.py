...
def parse_args():
    parser = argparse.ArgumentParser(
        description=(
            "GA deployment search with random trajectory seeds per iteration. "
            "Each iteration samples traj seeds randomly and uses them for fitness evaluation."
        )
    )
    ...
    parser.add_argument(
        ...
        default=(
            ...
            "ga_best_deployment_random{sample_size}_w{wind_seed}_g{terrain_seed}_i{infra_seed}"
...
def main():
    ...
    result_data = {
        ...
        "seeds": {
            ...
            # Compatibility keys kept for downstream scripts that expect these names.
    ...
    print("-" * 90)
    print("GA deployment search (random traj seeds per iteration) completed.")
